            ...
            <div className="bg-gradient-card p-8 rounded-2xl border border-border">
              ...
              <div className="space-y-6">
                {organizers.map((organizer, index) => (
                  <div 
                    key={organizer.name}
                    className="flex items-center gap-4 p-4 rounded-xl bg-muted/20 hover:bg-muted/30 transition-colors duration-300"
        ...
        <div className="mt-16 text-center scroll-fade-in">
          <div className="bg-gradient-card p-8 rounded-2xl border border-border max-w-4xl mx-auto">
            ...
            <p className="text-muted-foreground mb-6">
              ...
              We're here to ensure your IGNIXION experience is seamless and memorable.
            </p>
